export default class Popup {
    constructor(popupSelector) {
      console.log(`Popup constructor popupSelector:`, popupSelector);
      this._popup = document.querySelector(popupSelector);
      console.log(`Popup constructor this._popup:`, this._popup);
    ...
    setEventListeners() {
      this._popupBtnClose.addEventListener('click', this._handleCloseCallback);
    ...
    removeEventListeners() {
      this._popupBtnClose.removeEventListener('click', this._handleCloseCallback);
