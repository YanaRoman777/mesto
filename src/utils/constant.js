...
export const avatarImage= '.profile__img';
export const buttonEditSave= document.querySelector('#buttonEditSave');
export const buttonAddSave =document.querySelector('#buttonAddSave');
export const buttonAvatarSave =document.querySelector('#buttonAvatarSave');
export const buttonDelSave =document.querySelector('#buttonDelSave');